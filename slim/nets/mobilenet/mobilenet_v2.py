...
V2_DEF = dict(
    defaults={
        ...
        (ops.expanded_conv,): {
            ...
            'residual': True,
            'inner_activation_fn' : tf.nn.relu6,
    ...
    spec=[
        ...
        op(ops.expanded_conv, stride=1, num_outputs=24),#4
        op(ops.expanded_conv, stride=2, num_outputs=32),
        op(ops.expanded_conv, stride=1, num_outputs=32),
        op(ops.expanded_conv, stride=1, num_outputs=32),#7
        ...
        op(ops.expanded_conv, stride=1, num_outputs=96),
        op(ops.expanded_conv, stride=1, num_outputs=96),#14
