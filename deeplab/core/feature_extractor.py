...
# Default end point for ReXNet 
_REXNET_FINAL_ENDPOINT = 'layer_17'
...
def mobilenet_v2_arg_scope(is_training=True,
  ...
  with slim.arg_scope(
      ...
      slim.arg_scope([conv_blocks.expanded_conv], normalizer_fn=slim.batch_norm),\
...
_PREPROCESS_FN = {
    ...
    'rexnet' : _preprocess_zero_mean_unit_range,
}
